        ...
        Column(
            ...
            AnimatedContent(
                ...
                QuizQuestionCard(
                    ...
                    helperText = "Chọn nghĩa đúng từ các lựa chọn bên dưới",
                ...
                AnimatedVisibility(
                    ...
                    Column(modifier = Modifier.fillMaxWidth()) {
                        currentQuestion?.options?.forEachIndexed { index, option ->
                            val isCorrect = option == currentQuestion.questionWord.meaning
                            ...
                            QuizOption(
                                ...
                                onClick = {
                                    viewModel.onMultiChoiceSelect(option)
                                    if (showAnswer) {
                                        viewModel.submitMultiChoice()
                                    }
                                }
                            )
                            Spacer(Modifier.height(12.dp))
            ...
            QuizActionButton(
                showAnswer = showAnswer,
                userAnswerIsNotBlank = state.selectedOption != null,
                isCompleted = state.isCompleted,
                showResult = state.showResult,
                onNext = { viewModel.nextQuestion() },
                onSubmit = { viewModel.submitMultiChoice() },
                onComplete = {
